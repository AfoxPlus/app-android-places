package com.afoxplus.places.domain.repository.source.network.api
...
import com.afoxplus.places.domain.repository.source.network.api.response.EstablishmentResponse
...
internal interface EstablishmentApiNetwork {
    ...
    @POST("$PATH_RESTAURANT/autocomplete")
    suspend fun fetchEstablishmentsByQuery(@Body query: AutocompleteRequest): Response<BaseResponse<List<EstablishmentResponse>>>
